  ...
  awards: [
    {
      ...
      description:
        "Recognizes sustained improvements in outcomes, safety metrics, and follow-up adherence.",
    ...
    },
    {
      ...
      description:
        "Honors practical digital systems that improved turnaround time and care quality.",
    ...
    },
    {
      ...
      description:
        "Celebrates doctors driving medical awareness, mentorship, and ethical care access.",
  ...
  journal: [
    {
      ...
      tag: "Systems",
      summary:
        "A practical guide to multi-hospital referral workflows with compliant data transfer models.",
      readTime: "8 min read",
    ...
    },
    {
      ...
      tag: "Clinical AI",
      summary:
        "When to automate, when to review, and how to keep medico-legal reliability high.",
      readTime: "6 min read",
    ...
    },
    {
      ...
      tag: "Patient Care",
      summary:
        "Communication models that improve adherence, clarity, and long-term clinical relationships.",
      readTime: "5 min read",
      publishedAt: "March 2026"
    },
    {
      ...
      tag: "Leadership",
      summary:
        "A blueprint for mentorship circles, case-based learning, and professional growth loops.",
      readTime: "7 min read",
